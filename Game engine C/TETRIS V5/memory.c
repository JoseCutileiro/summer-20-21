...
SPRITES load_sprites(){
    ...
    /////////////////////// {I} ////////////////////////////
      ...
      // {2}
        ...
        strcpy(memory[I_2].info,",,X,,,X,,,X,,,X,");
